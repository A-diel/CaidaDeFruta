class Game{
    ...
    {       
            var x, y;
            /*
          //dividir los cudritos de manera exacta (el resultado tiene que ser 0) 
                obstacle=createSprite(600,35,40,10); 
                obstacle.velocityX=-3; 
                obstacle.x=Math.round(random(10,60));  //ramdom    //math.round(numeros enteros) 
                obstacle.lifetime=200;  //tiempo de vida 
            
               

                obstacle.addImage("obstacle",obstacles);
